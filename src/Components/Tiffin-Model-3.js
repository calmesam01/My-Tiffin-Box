...
function TiffinModel_3 (props) {
    return (
        <div>
            <img className = "tiffin-box-model-3" src = {props.Src3} style = {{maxWidth: "120%", maxHeight: "120%", padding: "0px 5px 0px 5px"}} />
        </div>
    );
};

export default TiffinModel_3; 