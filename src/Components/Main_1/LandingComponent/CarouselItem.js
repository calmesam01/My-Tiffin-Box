        ...
        <div className = "row">
            <div className = "col-md-6 landing_images_col">
                ...
                <Paper className = "paper_style">
                    <img src = {props.item.name == "1" ? Landing : Open_Tiffin} className = "landing_images_style"></img>
                    <center><button className = "landing_images_desc btn btn-lg">{props.item.description}</button></center> 
                </Paper>
            </div>
        </div>
    )
