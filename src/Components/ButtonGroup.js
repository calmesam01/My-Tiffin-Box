    ...
    return (
        <div className = "row order-now-page">
            ...
            <div className = "col-sm-4 col-md-4">
                <center><div className="btn-group-vertical fade-in-1" id="ButtonGroup" style = {{fontFamily: "optima"}}>
            ...
            <div className = "col-md-4 col-sm-4 tiffin-model" style = {AddedToCart ? {marginTop: "10px"} : {marginTop: "120px"}}>
                        <center>
                            ...
                            <div className = "col-md-12">
                                    <TiffinModel_1 Src1 = {Src_1} Src2 = {Src_2} Src3 = {Src_3} Src4 = {Src_4}/>
                                </div>
                        ...
                        <div className = "col-sm-12 col-md-12">
                            <center>
                                {AddedToCart &&
                                <div className = "order-final jumbotron fade-in-order">
                                ...
                                {AddToCart && <button type="submit" className = "btn btn-checkout fade-in-order" style = {{marginTop: "50px"}} onClick={SubmitVal}>  ADD TO CART </button>}
                                <br/>
                                {AddedToCart && 
                                <div>
                                    <div className = "row">
                                        <div className = "col-md-6 col-sm-12">
                                            <center><Link to="/Payment"><MDBBtn color="indigo" className = "btn btn-checkout fade-in-order" onClick={Proceed} type="submit">CHECKOUT</MDBBtn></Link></center>
                                        </div>
                                        <div className = "col-md-6 col-sm-12">
                                        <center><MDBBtn color="indigo" className = "btn btn-checkout fade-in-order" onClick={ResetTiffin} type="submit">EMPTY TIFFIN</MDBBtn></center>
                                        </div>
                                    </div>
                                </div>}
