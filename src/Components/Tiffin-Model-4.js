...
function TiffinModel_4 (props) {
    return (
        <div>
            <img className = "tiffin-box-model-4" src = {props.Src4} style = {{maxWidth: "120%", maxHeight: "120%", padding: "0px 5px 0px 5px"}} />
        </div>
    );
};

export default TiffinModel_4; 